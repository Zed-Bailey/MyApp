...
function Application() {
  ...
  const [activeTabLink, setTabLinkActive] = useState("Products");
  ...
  const tabs = {
    account: [
      { link: "/customer/products", label: "Products", icon: IconGift },
  ...
  const tabLinks = tabs[section].map((item) => (
    <a
      className={cx(classes.tabLink, {
        [classes.linkActive]: item.label === activeTabLink,
      })}
      href={item.link}
      key={item.label}
      onClick={(event) => {
